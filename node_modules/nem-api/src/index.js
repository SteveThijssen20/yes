...
module.exports = class nisapi {
  ...
  /**
   * makeTX2 - Make a mosaic transaction given a transaction object and a private key.
   *
   * @param  {txobject} options    Transaction object.
   * @param  {MosaicsMetaData} mosaic   Mosaic metadata in NIS format.
   * @param  {String} privatekey   A private NEM key.
   * @return {parsedtxobject}      An object ready to be signTX'd.
   */
    makeTX2(options, mosaic, privatekey) {
        var transaction = txn.prepareTransferV2({"privatekey": privatekey}, mosaic, options);
        return transaction;
    }
